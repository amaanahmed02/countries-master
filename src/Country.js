...
const Country = ({ match }) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://restcountries.com/v2/name/${match.params.country}?fullText=true`
      )
        ...
        .then((res) =>
          setBorderCountries(
            country[0].borders.map((c) =>
              res.data.filter((cr) => cr.alpha3Code === c)
            )
          )
        );
    }
                  ...
                  <div className="more-info">
                    ...
                    <ul className="col-2 col">
                      ...
                      <li>
                        ...
                        <span>
                          {country[0].currencies.map((c) => c.name).join(", ")}{" "}
                        </span>{" "}
                      </li>
                      <li>
                        {" "}
                        ...
                        <span>
                          {country[0].languages.map((c) => c.name).join(", ")}
                        </span>{" "}
                      </li>
                    </ul>
                  </div>
